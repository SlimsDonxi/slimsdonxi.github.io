var currentText =0;
var array = ["shake", "shade", "shape", "shack", "she","sheep",
  "sheet", "shed","shy", "shine", "shell", "shin", "shoe", "shut",
 
  "shop", "shoot", "ship", "shot", "ash", "bash", "dash", "flash", "trash", "cash", "mesh", "flesh", "fish", "wash", "push" 
...
var block = element.innerText.replace(/sh/g,`<label style="color:#f12a5d">sh</label>`);
