var currentText =0;
var array = ["chip", "chat", "chow", "chew", "chin", "chop","chess",
  "chic", "chase","chalk", "china", "chirp", "chest", "catch",
  "batch", "fetch", "watch", "match" 
...
var block = element.innerText.replace(/ch/g,`<label style="color:#f12a5d">ch</label>`);
